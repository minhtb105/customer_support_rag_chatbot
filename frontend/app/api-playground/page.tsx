      ...
      <div className="rounded-2xl border bg-white p-5 shadow-sm">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="sm:col-span-2">
            <label htmlFor="playground-query" className="text-xs font-medium">Câu hỏi</label>
            <textarea id="playground-query" data-testid="playground-query" value={query} onChange={(e) => setQuery(e.target.value)} rows={3} className="mt-1 w-full rounded-lg border px-3 py-2 text-sm" placeholder="Nhập câu hỏi y tế..." />
          ...
          <div className="space-y-3">
            <div>
              <label htmlFor="playground-userid" className="text-xs">User ID</label>
              <input id="playground-userid" data-testid="playground-userid" value={userId} onChange={(e) => setUserId(e.target.value)} className="mt-1 w-full rounded-lg border px-3 py-2 text-sm" />
            </div>
            <div>
              <label htmlFor="playground-topk" className="text-xs">Top K: {topK}</label>
              <input id="playground-topk" data-testid="playground-topk" type="range" min={3} max={10} value={topK} onChange={(e) => setTopK(Number(e.target.value))} className="w-full" />
            </div>
