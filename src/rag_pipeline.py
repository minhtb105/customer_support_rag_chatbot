...
try:
    ...
    from generator import generate_answer, generate_answer_stream, rerank_contexts, format_answer_for_ui, detect_tone_and_temp
    ...
    from src.generator import generate_answer, generate_answer_stream, rerank_contexts, format_answer_for_ui, detect_tone_and_temp
    ...
    if _eval2 is not None:
        try:
            ...
            if is_low:
                ...
                try:
                    from src.generator import detect_tone_and_temp as _detect
