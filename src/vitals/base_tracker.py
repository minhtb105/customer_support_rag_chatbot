...
Usage:
    from src.vitals.base_tracker import get_conn, init_table, fetch_logs, classification_counts, calc_streak, calc_logs_per_week
"""
...
try:
    from src.shared.config import VITALS_DB_PATH, GLUCOSE_DB_PATH
except ImportError:  # pragma: no cover
    from shared.config import VITALS_DB_PATH, GLUCOSE_DB_PATH  # type: ignore
