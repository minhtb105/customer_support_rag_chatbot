...
def _extract_doctors(text: str) -> List[str]:
    ...
    try:
        try:
            from src.features.slot_generator import load_doctors
        except ImportError:
            from features.slot_generator import load_doctors  # type: ignore
...
def _validate_llm_doctor(raw: str) -> Optional[str]:
    ...
    try:
        try:
            from src.features.slot_generator import resolve_doctor
        except ImportError:
            from features.slot_generator import resolve_doctor  # type: ignore
