...
try:
    from src.features import slot_generator as _sg
except ImportError:  # pragma: no cover
    import features.slot_generator as _sg  # type: ignore
...
def real_distance_km(doctor_id: str, patient_id: Optional[str] = None) -> Optional[float]:
    ...
    try:
        try:
            from src.features.synthetic_roster import get_patient_location, get_doctor_location
        except ImportError:
            from features.synthetic_roster import get_patient_location, get_doctor_location  # type: ignore
