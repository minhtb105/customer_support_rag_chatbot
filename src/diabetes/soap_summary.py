...
try:
    from src.diabetes.glucose_tracker import get_logs, get_stats
    ...
    from src.shared.memory import get_long_term_memory
    from src.shared.config import DEFAULT_MODEL
except ImportError:  # pragma: no cover
    from diabetes.glucose_tracker import get_logs, get_stats  # type: ignore
    from vitals.bp_tracker import get_bp_logs, get_bp_stats  # type: ignore
    from vitals.respiratory_tracker import get_respiratory_logs, get_respiratory_stats  # type: ignore
    from vitals.mood_tracker import get_mood_logs, get_mood_stats  # type: ignore
    from shared.memory import get_long_term_memory  # type: ignore
    from shared.config import DEFAULT_MODEL  # type: ignore
