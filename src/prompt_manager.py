...
try:
    from src.observability.tracing_db import get_active_prompt, create_prompt, approve_prompt, list_prompts
    from src.observability.local_tracing import short_hash
except ImportError:
    from observability.tracing_db import get_active_prompt, create_prompt, approve_prompt, list_prompts  # type: ignore
    from observability.local_tracing import short_hash  # type: ignore
...
try:
    from src.config import PROMPT_ACTIVE_CACHE_TTL_SECONDS
except ImportError:
    from config import PROMPT_ACTIVE_CACHE_TTL_SECONDS  # type: ignore
