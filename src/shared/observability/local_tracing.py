...
try:
    from src.shared.observability.tracing_db import create_trace, update_trace, create_span, end_span, add_span_chunks
except ImportError:
    from shared.observability.tracing_db import create_trace, update_trace, create_span, end_span, add_span_chunks  # type: ignore
